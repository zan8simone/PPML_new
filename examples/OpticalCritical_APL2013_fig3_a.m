...
epsyA = [              1            1              1            1                       ]; % material A 
epszA = [              1            1              1            1                       ]; %
epsxB = [              epsAu        epsGaAs        epsGaAs      epsGaAs_dop             ]; % material B
epsyB = [              epsAu        epsGaAs        epsGaAs      epsGaAs_dop             ]; % material B
...
%%
figure(1)
hpl = pcolor(theta,nu,R_TM);
set(hpl,'edgecolor','none')
xlabel('incidence angle (deg)')
ylabel('frequency (THz)')
title('TM case')

figure(2)
hpl = pcolor(theta,nu,R_TE);
set(hpl,'edgecolor','none')
xlabel('incidence angle (deg)')
ylabel('frequency (THz)')
title('TE case')