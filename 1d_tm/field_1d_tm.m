...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This is free software distributed under the BSD license (see the 
%  containing folder).
...
% nx             -> number of points along x for field display    [integer]
% nz             -> number of points along z for field display, specified for each internal layer [1x(L+2) integer]
%
% -------------------------------------------------------------------------
%                             OUTPUTS
%
% x, z           -> vectors of x and z points where field is computed
% Ex, Ez         -> E field x- and z-components calculated at the grid points
% Sz             -> Poynting vector z-component averaged over the unit cell [function of z] 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
